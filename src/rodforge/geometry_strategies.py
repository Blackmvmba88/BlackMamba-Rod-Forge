...
STRATEGIES: dict[str, GeometryStrategy] = {
    ...
    "chassis_rails": GeometryStrategy(
        ...
        family="chassis",
        builder="rail_frame",
        params={"length": 4.8, "rail_width": 0.24, "rail_height": 0.28, "rail_offset": 0.62},
    ...
    "cabin_chopped": GeometryStrategy(
        ...
        params={
            ...
            "roof_location": (0.48, 0.0, 1.95),
            "roof_scale": (1.62, 1.58, 0.42),
        },
    ...
    "body_tapered": GeometryStrategy(
        ...
        params={
            ...
            "length": 2.35,
            "rear_half_width": 0.88,
            "front_half_width": 0.68,
            "bottom_z": -0.66,
            "top_z": 0.70,
        },
